...
public class Imp1Parser implements Imp1ParserConstants {
  ...
  static final public Load PLoad() throws ParseException {
    ...
    default:
      ...
      ;
        ...
        String path = pathToken.image.substring(1, pathToken.image.length() - 1); // Remove as aspas
        String alias = (idTok != null) ? idTok.image : null;
  ...
  static final public Save PSave() throws ParseException {
    ...
    pathToken = jj_consume_token(STRING_LITERAL);
        ...
        {if (true) return new Save(path, alias);}
    throw new Error("Missing return statement in function");
  }

  static final public Comando PClean() throws ParseException {
    Token t1;
    String nomeVariavel;
    String action;
        String coluna;
    ...
    t1 = jj_consume_token(IDENTIFIER);
                        nomeVariavel = t1.image;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DROP:
      jj_consume_token(DROP);
          action = "DROP";
      columnList = PColumnList();
          {if (true) return new Clean(nomeVariavel, action, columnList);}
      break;
    case FILL:
      jj_consume_token(FILL);
          action = "FILL";
      columnValuePairs = PColumnValuePairs();
          {if (true) return new Clean(nomeVariavel, action, columnValuePairs);}
      break;
    case DROPROWS:
      jj_consume_token(DROPROWS);
          action = "DROPROWS";
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IDENTIFIER:
        columnList = PColumnList();
    ...
    case RENAME:
      ...
      oldNewPairs = POldNewPairList();
          {if (true) return new Clean(nomeVariavel, action, oldNewPairs, true);}
      break;
    case REPLACE:
      ...
      oldNewPairs = PReplacePairList();
          {if (true) return new Clean(nomeVariavel, action, coluna, oldNewPairs);}
      break;
    case IDENTIFIER:
      t1 = jj_consume_token(IDENTIFIER);
            action = t1.image;
            {if (true) return new Clean(nomeVariavel, action.toLowerCase());}
      break;
    default:
      jj_la1[4] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public Comando PNormalize() throws ParseException {
    Token t1;
    String nomeVariavel;
    List columnList = new ArrayList();
    ...
    default:
      ...
      ;
        ...
        if (columnList.isEmpty()) {
            {if (true) return new Normalize(nomeVariavel);}
        } else {
            {if (true) return new Normalize(nomeVariavel, columnList);}
        }
    throw new Error("Missing return statement in function");
  }

  static final public Comando PTransform() throws ParseException {
    Token t1;
    String nomeVariavel;
    String operation;
    Map columnValuePairs = new HashMap();
    ...
    case ADD:
      ...
      columnValuePairs = PNumericPairs();
          {if (true) return new Transform(nomeVariavel, operation, columnValuePairs);}
      break;
    case MULT:
  ...
  static final public Map PNumericPairs() throws ParseException {
    Token colName, value;
    Map pairs = new HashMap();
    String valorNumerico;
    colName = jj_consume_token(IDENTIFIER);
    ...
    case INTEGER_LITERAL:
      ...
      break;
    case FLOAT_LITERAL:
      value = jj_consume_token(FLOAT_LITERAL);
      break;
    default:
      jj_la1[7] = jj_gen;
      jj_consume_token(-1);
...
/*  ADICIONADO OU MODIFICADO DA Imperativa1 PARA A Imperativa2  */
  ...
  static final public List PColumnList() throws ParseException {
    Token t;
    List columnList = new ArrayList();
    t = jj_consume_token(IDENTIFIER);
                       columnList.add(t.image);
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
  ...
  static final public Map PColumnValuePairs() throws ParseException {
    Token colName, value;
    Map pairs = new HashMap();
  ...
  static final public Map POldNewPairList() throws ParseException {
    Token oldName, newName;
    Map pairs = new HashMap();
    oldName = jj_consume_token(IDENTIFIER);
    jj_consume_token(ASSIGN);
  ...
  static final public Map PReplacePairList() throws ParseException {
  ...
  static private boolean jj_3R_51() {
    if (jj_scan_token(DROPROWS)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  static private boolean jj_3R_32() {
    if (jj_scan_token(CLEAN)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_49()) {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x53b0000,0x180000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x6000,0x6000,0x1006000,0x1800,0x1006000,0x53b0000,0x1008000,0x80000000,0x80000000,0x80000000,0x80000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x3e,0x0,0x40,0x0,0xf80,0x0,0x3000,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x0,0x3e,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x800,0x0,0x0,0x800,0x800,0x800,0x0,0x220,0x0,0x220,0x0,0x420,0xc20,0x0,0xc20,0x800,0x0,0x0,0x0,0x0,0x0,};
   }
